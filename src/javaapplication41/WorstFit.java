 ...
 * @author Eslam
 */
public class WorstFit extends JPanel {
    ...
    /*This is an algorithm that returns the Worstfit for each process*/
    public int BadFit(ArrayList<Integer> Hsizes, ArrayList<Integer> Psizes,int n){
             ...
             for(int r=0;r<HoleNo;r++)
             {
                 ...
                 */
                 if(Hsizes.get(r) >= Psizes.get(n) && R1.get(r) != 0){
                  ...
                  else if(Hsizes.get(Worst) < Hsizes.get(r) && R1.get(r) != 0){
                     Worst=r;
    ...
    public void WFit(ArrayList<Integer> Hsizes,int n)
    {
            /*reset position*/
            y3=115;
            Pi.add(new JLabel());
            int Worst = BadFit(L1,L2,n);
            if(Worst !=-1){
             for(int r=0;r<HoleNo;r++)
             {
                 if(Hsizes.get(r) == Hsizes.get(Worst) )
                  break;
                 else
                  y3=y3+60;
             }
